                ...
                <Link to={`/product-details/${el?._id}`}>
                  <div className="sm:w-36 md:w-40 w-full h-fit bg-white shadow bg-blend-overlay rounded    p-2">
                    ...
                    <div className="p-1">
                      ...
                      <button className="bg-purple px-3 py-1 rounded-full text-white font-semibold uppercase  text-xs hover:bg-midnight transition-all duration-300 ease-linear"onClick={(e)=>handleAddToCart(e, el?._id)}>
                        Add to cart
                      </button>
                    </div>
                  </div>
